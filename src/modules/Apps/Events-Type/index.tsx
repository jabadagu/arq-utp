...
import { useFetchEventTypes } from "./hooks/useEventTypeList";
...
import {
  ...
  CONFIRM_BUTTONS,
  ModalMode,
} from "./content/eventType.content";
import { useEventTypeMutations } from "./hooks/useEventTypeMutations";
import TableActions from "./components/TableActions";
import ModalForm from "@/shared/components/ModalForm";
import CreateEventTypeForm from "./components/CreateEventTypeForm";

const EventsType: React.FC = () => {
  const { data, loading } = useFetchEventTypes();

  const { deleteMutation } = useEventTypeMutations();
  ...
  return (
    <>
      ...
      <ModalForm
        ...
        texts={{ title: CONFIRMS.deleteEventType }}></ModalForm>
    </>
  );
};
